<?php
    ...
    if (isset($_GET["user"])) {
        ...
        $result = mysql_query("
            SELECT DISTINCT course.CourseID AS CourseID, course.Title AS Title, 
                            session.StartDate AS StartDate, session.Location AS Location, course.CourseType AS CourseType
            ...
            SELECT DISTINCT course.CourseID AS CourseID, course.Title AS Title, 
                            register.DateRegistered AS StartDate, online.URL AS Location, course.CourseType AS CourseType
